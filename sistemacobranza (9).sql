...
-- Tiempo de generación: 29-10-2018 a las 13:20:01
...
SELECT pd.idDetallePago,pd.ImportePago,pd.NombrePago,pd.Estado_idEstado from pagodetalle pd WHERE pd.Alumno_idAlumno=idAlumnoP and pd.year=yearP and pd.Estado_idEstado=9;
...
SELECT cu.idCuota,cu.Importe,cu.Diferencia,cu.Mora,cu.Estado_idEstado,e.nombreEstado,cu.Alumno_idAlumno,cu.year,DATE_FORMAT(cu.fechaVencimiento,"%d/%m/%Y") as fechaVencimiento,
(IF(DATE_FORMAT(NOW(),"%Y-%m-%d")>cu.fechaVencimiento,DATEDIFF(DATE_FORMAT(NOW(),"%Y-%m-%d"), cu.fechaVencimiento),0)) as DiasMora
FROM alumno al INNER JOIN cuota cu ON cu.Alumno_idAlumno=al.idAlumno LEFT JOIN estado e ON e.idEstado=cu.Estado_idEstado WHERE cu.Alumno_idAlumno=idAlumnoU and cu.year=yearU;
...
(873, 4, NULL, '200.00', '200.00', '0.00', 2017, 3, '2017-03-01', '2017-03-30', 5),
(874, 4, NULL, '200.00', '200.00', '0.00', 2017, 4, '2017-04-01', '2017-04-30', 5),
(875, 4, NULL, '200.00', '200.00', '0.00', 2017, 5, '2017-05-01', '2017-05-30', 5),
(876, 4, NULL, '200.00', '200.00', '0.00', 2017, 6, '2017-06-01', '2017-06-30', 5),
(877, 4, NULL, '200.00', '200.00', '0.00', 2017, 7, '2017-07-01', '2017-07-30', 5),
