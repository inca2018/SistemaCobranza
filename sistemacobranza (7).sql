...
-- Tiempo de generación: 30-10-2018 a las 22:51:03
...
SET TotalGeneral=(SELECT alu.Importe FROM alumnopagos alu WHERE alu.Alumno_idAlumno=idAlumnoU and alu.year=yearU and alu.idAlumnoPago=idMatriculaU);

	IF(tipoPagoU=1)THEN 
    	 SET TotalRecuperado=(SELECT alu.Diferencia FROM alumnopagos alu WHERE alu.Alumno_idAlumno=idAlumnoU and alu.year=yearU and alu.idAlumnoPago=idMatriculaU);
          SET  TotalRecuperado=TotalRecuperado+importPagarU;
          IF((TotalGeneral-TotalRecuperado)=0)THEN
          	UPDATE `alumnopagos` SET `Diferencia`=TotalRecuperado,`Estado_idEstado`=5 WHERE `idAlumnoPago`=idMatriculaU and `Alumno_idAlumno`=idAlumnoU and `year`=yearU; 
          ELSE
          	UPDATE `alumnopagos` SET `Diferencia`=TotalRecuperado,`Estado_idEstado`=6 WHERE `idAlumnoPago`=idMatriculaU and `Alumno_idAlumno`=idAlumnoU and `year`=yearU; 
          END IF;
    ELSE 
    SET TotalRecuperado=(SELECT alu.Mora FROM alumnopagos alu WHERE alu.Alumno_idAlumno=idAlumnoU and alu.year=yearU and alu.idAlumnoPago=idMatriculaU);
    
    SET  TotalRecuperado=TotalRecuperado+importPagarU;   
    	IF((TotalGeneral-TotalRecuperado)=0)THEN
      		UPDATE `alumnopagos` SET `Mora`=TotalRecuperado WHERE `idAlumnoPago`=idMatriculaU and `Alumno_idAlumno`=idAlumnoU and `year`=yearU;  
     	ELSE 
      		UPDATE `alumnopagos` SET `Mora`=TotalRecuperado WHERE `idAlumnoPago`=idMatriculaU and `Alumno_idAlumno`=idAlumnoU and `year`=yearU;  
      	END IF; 
    END IF;
...
SET TotalGeneral=(SELECT cu.Importe FROM cuota cu WHERE cu.idCuota=idCuotaU and cu.Alumno_idAlumno=idAlumnoU and cu.year=yearU);
    ...
    IF (tipoPagoU=1)THEN
    	SET TotalRecuperado=(SELECT cu.Diferencia FROM cuota cu WHERE cu.idCuota=idCuotaU and cu.Alumno_idAlumno=idAlumnoU and cu.year=yearU);
     	SET  TotalRecuperado=TotalRecuperado+importPagarU;     
     	IF((TotalGeneral-TotalRecuperado)=0)THEN
     		 UPDATE `cuota` SET `Diferencia`=TotalRecuperado,`Estado_idEstado`=5  WHERE `idCuota`=idCuotaU and `Alumno_idAlumno`=idAlumnoU and `year`=yearU;
     	ELSE 
         	 UPDATE `cuota` SET `Diferencia`=TotalRecuperado,`Estado_idEstado`=6  WHERE `idCuota`=idCuotaU and `Alumno_idAlumno`=idAlumnoU and `year`=yearU;
     	END IF;
    ELSE 
    	...
    	SET TotalRecuperado=(SELECT cu.Mora FROM cuota cu WHERE cu.idCuota=idCuotaU and cu.Alumno_idAlumno=idAlumnoU and cu.year=yearU);
    	 SET  TotalRecuperado=TotalRecuperado-importPagarU;           
      		UPDATE `cuota` SET `Mora`=TotalRecuperado,`Estado_idEstado`=5   WHERE `idCuota`=idCuotaU and `Alumno_idAlumno`=idAlumnoU and `year`=yearU;
...
UPDATE `alumnopagos` SET  `Diferencia`=@PagoDiferencia,`Estado_idEstado`=@ESTADO WHERE `Alumno_idAlumno`=idAlumnoP and `year`=yearP and `TipoPago_idTipoPago`=codigoPago;  
    ...
    SET @PagoMora=(impMora-pagarMora);
		...
		INSERT INTO `pagodetalle`(`idDetallePago`, `Cabecera_idCabecera`, `Alumno_idAlumno`, `year`,`TipoPago`, `NombrePago`, `ImportePago`, `Cuota_idCuota`, `TipoPago_idTipoPago`, `fechaRegistro`, `Estado_idEstado`) VALUES (NULL,NULL,idAlumnoP,yearP,2,CONCAT("MORA DE ",TituloPago),pagarMora,NULL,codigoPago,NOW(),9);
...
(1, 4, 2017, 1, '250.00', '250.00', '0.00', 5, '2018-10-28 00:47:31'),
(2, 4, 2017, 3, '120.00', '120.00', '0.00', 5, '2018-10-28 00:47:31'),
(3, 4, 2017, 4, '100.00', '100.00', '0.00', 5, '2018-10-28 00:47:31'),
(4, 4, 2017, 5, '120.00', '120.00', '0.00', 5, '2018-10-28 00:47:31'),
(5, 4, 2017, 6, '100.00', '100.00', '0.00', 5, '2018-10-28 00:47:31'),
(6, 4, 2017, 7, '200.00', '200.00', '0.00', 5, '2018-10-28 00:47:31'),
...
(873, 4, NULL, '200.00', '0.00', '579.00', 2017, 3, '2017-03-01', '2017-03-30', 7),
(874, 4, NULL, '200.00', '0.00', '548.00', 2017, 4, '2017-04-01', '2017-04-30', 7),
(875, 4, NULL, '200.00', '0.00', '518.00', 2017, 5, '2017-05-01', '2017-05-30', 7),
(876, 4, NULL, '200.00', '0.00', '487.00', 2017, 6, '2017-06-01', '2017-06-30', 7),
(877, 4, NULL, '200.00', '0.00', '457.00', 2017, 7, '2017-07-01', '2017-07-30', 7),
(878, 4, NULL, '200.00', '200.00', '0.00', 2017, 8, '2017-08-01', '2017-08-30', 5),
(879, 4, NULL, '200.00', '200.00', '0.00', 2017, 9, '2017-09-01', '2017-09-30', 5),
(880, 4, NULL, '200.00', '200.00', '0.00', 2017, 10, '2017-10-01', '2017-10-30', 5),
(881, 4, NULL, '200.00', '200.00', '0.00', 2017, 11, '2017-11-01', '2017-11-30', 5),
(882, 4, NULL, '200.00', '200.00', '0.00', 2017, 12, '2017-12-01', '2017-12-30', 5),
...
(1, 1, 'admin', '$2a$08$RCuzW/8g2Lg4QMNCfmsa/uKp33rvDmdWrC.P40DOECJlMtPu16NMW', 'Administrador', '2018-09-29 14:03:44', '::1', '2018-10-30 16:18:27');
...
(55, NULL, 4, 2017, 1, 'PENSIÓN MARZO', '200.00', 873, NULL, '2018-10-30 13:41:03', 9),
(56, NULL, 4, 2017, 2, 'MORA DE PENSIÓN MARZO', '579.00', 873, NULL, '2018-10-30 13:41:03', 9),
(59, NULL, 4, 2017, 1, 'PENSIÓN ABRIL', '200.00', 874, NULL, '2018-10-30 14:26:38', 9),
(60, NULL, 4, 2017, 2, 'MORA DE PENSIÓN ABRIL', '548.00', 874, NULL, '2018-10-30 14:26:38', 9),
(61, NULL, 4, 2017, 1, 'PENSIÓN MAYO', '200.00', 875, NULL, '2018-10-30 14:30:23', 9),
(62, NULL, 4, 2017, 2, 'MORA DE PENSIÓN MAYO', '518.00', 875, NULL, '2018-10-30 14:30:23', 9),
(63, NULL, 4, 2017, 1, 'PENSIÓN JUNIO', '200.00', 876, NULL, '2018-10-30 14:30:29', 9),
(64, NULL, 4, 2017, 2, 'MORA DE PENSIÓN JUNIO', '487.00', 876, NULL, '2018-10-30 14:30:29', 9),
(65, NULL, 4, 2017, 1, 'PENSIÓN JULIO', '200.00', 877, NULL, '2018-10-30 14:30:34', 9),
(66, NULL, 4, 2017, 2, 'MORA DE PENSIÓN JULIO', '457.00', 877, NULL, '2018-10-30 14:30:34', 9);
...
(4, 'jincar', '$2a$08$bozs54ZTsSidluIQpZRNV.c77oNFtkJILAK/U08o3.Q13g07XSmxi', 9, 41, 1, '2018-10-30 16:09:55');
