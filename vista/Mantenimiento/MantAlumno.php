                            ...
                            <div role="tabpanel">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane panelAccion" id="op_info" role="tabpanel">
                                        <div class="container">
                                            <div class="row">
                                                <button type="button" id="boton_cambios" onclick="ActualizarPagos();" class="btn btn-success col-md-2 offset-10 "> Guardar Cambios</button>
                                            </div>
                                            <hr>
                                            <h5 class="mt-2 mb-2 titulo_area3" id="titulo_gasto"><em><b>Seleccione Pagos del Alumno:</b></em></h5>
                                    ...
                                    <div class="tab-pane panelAccion" id="op_cuotas" role="tabpanel">
                                        <div class="container">
                                            <div class="row mt-3">
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control texto-x12" id="CantidadCuota" name="CantidadCuota" onkeypress="return SoloNumerosModificado(event,2,this.id);">
                                                </div>
                                                <button type="button" class="btn btn-success btn-sm col-md-3" title="Agregar Cuota" onclick="AgregarCuota();" id="button_nueva_cuota">
                                                    <i class="fa fa-plus fa-lg mr-2"></i>Agregar Cuota
                                                </button>
                                            </div>
                                            <hr>
                                            <h5 class="mt-2 mb-2 titulo_area3" id="titulo_editar_cuota" style="display:none"><em><b>Editar Cuota:</b></em></h5>
                                            <div id="area_Edicion" class="row mt-3 mb-3" style="display:none">
                                            <input type="hidden" id="CuotaEdicion">

                                                    <div class="col-md-4">

                                                        <label for="FechaInicio" class="col-form-label">F.Inicio:</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="FechaFin" class="col-form-label"> F.Vencimiento :</label>

                                                        <div class="input-group date" id="dateFin">
                                                            <input class="form-control" type="text" id="FechaFin" name="FechaFin" autocomplete="off">
                                                            <span class="input-group-append input-group-addon">
                                                    ...
                                                    <div class="row col-md-4 mt-4">
                                                        <button type="button" class="btn btn-warning btn-sm" title="Editar Cuota" onclick="ActualizarFecha();">
                                                            Editar Cuota
                                                        </button>
                                                    </div>
