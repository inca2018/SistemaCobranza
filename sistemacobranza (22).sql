...
-- Tiempo de generación: 26-11-2018 a las 13:14:50
...
DROP PROCEDURE IF EXISTS `SP_COMUNICADO`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_COMUNICADO` (IN `titulo` VARCHAR(150), IN `Documento` VARCHAR(150))  NO SQL
BEGIN 

SET @Existe=(SELECT COUNT(*) FROM comunicado);

if(@Existe=0)then 
INSERT INTO `comunicado`(`idComunicado`, `Titulo`, `Documento`, `fechaRegistro`) VALUES (NULL,titulo,Documento,NOW());
else 
UPDATE `comunicado` SET `Titulo`=titulo,`Documento`=Documento,`fechaRegistro`=NOW() WHERE`idComunicado`=1;
end if;
...
DROP PROCEDURE IF EXISTS `SP_GENERACION_REPORTE`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_GENERACION_REPORTE` (IN `years` VARCHAR(100), IN `mes` VARCHAR(100))  NO SQL
BEGIN 
DECLARE done INT DEFAULT FALSE;
DECLARE Cont INT;
...
CuotaTotal INT(11), 
CuotaPagada INT(11), 
CuotaNoPagada INT(11),
CuotaPagadaAnterior INT(11),
CuotaNoPagadaAnterior INT(11),
AlumnoNombre VARCHAR(150)    
);   

SET Inicio=(DATE_FORMAT(CONCAT(years,'-',if(mes<10,mes,CONCAT("0",mes)),"-01"),"%Y%m%d")); 

SET Fin =(SELECT LAST_DAY(Inicio));
...
SET @CuotaTotales=(SELECT COUNT(DISTINCT cu.idCuota) as NumeroCuota FROM cuota cu INNER JOIN pagodetalle pg ON pg.Cuota_idCuota=cu.idCuota WHERE cu.year=years and cu.Mes=mes);

SET @CuotaPendiente=( 
SELECT COUNT(DISTINCT cu.idCuota) as NumeroCuota FROM cuota cu INNER JOIN pagodetalle pg ON pg.Cuota_idCuota=cu.idCuota WHERE DATE_FORMAT(pg.fechaRegistro,"%Y-%m-%d")<=diaTemporal);

SET @DiaAnterior=(DATE(DATE_SUB(diaTemporal,INTERVAL 1 DAY)));


IF(Cont=1)then 
	SET @PendienteTemporal=@CuotaTotales;

    SET @dia=(DAYOFWEEK(diaTemporal));
    if(@dia=7 or @dia=1)then 
    SET @dia=null;
    else
    INSERT INTO TablaTemporal(fecha,CuotaTotal,CuotaPagada,CuotaNoPagada,CuotaPagadaAnterior,CuotaNoPagadaAnterior,AlumnoNombre) VALUES (diaTemporal,@CuotaTotales,@CuotaPendiente,(@CuotaTotales-@CuotaPendiente),@PendienteTemporal,(@CuotaTotales-@PendienteTemporal),CONCAT(Cont));   
    end if;


else 
    SET @PendienteTemporal=( 
    SELECT COUNT(DISTINCT cu.idCuota) as NumeroCuota FROM cuota cu INNER JOIN pagodetalle pg ON pg.Cuota_idCuota=cu.idCuota WHERE DATE_FORMAT(pg.fechaRegistro,"%Y-%m-%d")<=@DiaAnterior);
...
INSERT INTO `comunicado` (`idComunicado`, `Titulo`, `Documento`, `fechaRegistro`) VALUES
(1, 'COMUNICADO PRUEBA', 'Comunicado.pdf', '2018-11-24 20:23:57');
...
(1, 1, 'admin', '$2a$08$RCuzW/8g2Lg4QMNCfmsa/uKp33rvDmdWrC.P40DOECJlMtPu16NMW', 'Administrador', '2018-09-29 14:03:44', '::1', '2018-11-24 20:24:08');
...
(21, 77, 4, 2018, 1, 'PENSIÓN OCTUBRE', '200.00', 1046, NULL, '2018-10-02 00:18:34', 10),
(22, 77, 4, 2018, 2, 'MORA DE PENSIÓN OCTUBRE', '17.00', 1046, NULL, '2018-10-02 00:18:34', 10),
...
(41, 81, 5, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1056, NULL, '2018-10-03 17:08:18', 10),
(42, 81, 5, 2018, 2, 'MORA DE PENSIÓN OCTUBRE', '24.00', 1056, NULL, '2018-10-03 17:08:18', 10),
...
(88, 85, 6, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1066, NULL, '2018-10-04 17:25:37', 10),
(89, 85, 6, 2018, 2, 'MORA DE LA PENSIÓN OCTUBRE', '25.00', 1066, NULL, '2018-10-04 17:25:37', 10),
...
(115, 87, 7, 2018, 1, 'PENSIÓN OCTUBRE', '200.00', 1076, NULL, '2018-10-09 17:27:29', 10),
(116, 87, 7, 2018, 2, 'MORA DE LA  PENSIÓN OCTUBRE', '25.00', 1076, NULL, '2018-10-09 17:27:29', 10),
...
(153, 89, 8, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1086, NULL, '2018-10-11 18:41:19', 10),
(154, 89, 8, 2018, 2, 'MORA DE LA PENSIÓN OCTUBRE', '25.00', 1086, NULL, '2018-10-11 18:41:19', 10),
...
(173, 90, 9, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1096, NULL, '2018-10-15 18:42:39', 10),
(174, 90, 9, 2018, 2, 'MORA DE LA PENSIÓN OCTUBRE', '25.00', 1096, NULL, '2018-10-15 18:42:39', 10),
...
(195, 91, 10, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1106, NULL, '2018-10-19 18:43:33', 10),
(196, 91, 10, 2018, 2, 'MORA DE LA PENSIÓN OCTUBRE', '25.00', 1106, NULL, '2018-10-19 18:43:33', 10),
...
(217, 92, 11, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1116, NULL, '2018-10-22 18:47:38', 10),
(218, 92, 11, 2018, 2, 'MORA DE LA PENSIÓN OCTUBRE', '25.00', 1116, NULL, '2018-10-22 18:47:38', 10),
...
(239, 93, 12, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1126, NULL, '2018-10-23 18:48:36', 10),
(240, 93, 12, 2018, 2, 'MORA DE LA PENSIÓN OCTUBRE', '25.00', 1126, NULL, '2018-10-23 18:48:36', 10),
...
(261, 94, 13, 2018, 1, 'PENSIÓN  OCTUBRE', '200.00', 1136, NULL, '2018-10-30 18:49:20', 10),
(262, 94, 13, 2018, 2, 'MORA DE LA PENSIÓN OCTUBRE', '25.00', 1136, NULL, '2018-10-30 18:49:20', 10),
