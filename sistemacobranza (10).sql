...
-- Tiempo de generación: 30-10-2018 a las 12:40:33
...
SELECT ge.idGeneral as idPago,ge.NombrePago,alu.Importe,alu.Diferencia,alu.Mora,alu.Estado_idEstado,e.nombreEstado,alu.Alumno_idAlumno,alu.year FROM alumno al INNER JOIN alumnopagos alu ON alu.Alumno_idAlumno=al.idAlumno LEFT JOIN generalimportes ge ON ge.idGeneral=alu.TipoPago_idTipoPago LEFT JOIN estado e ON e.idEstado=alu.Estado_idEstado where alu.Alumno_idAlumno=idAlumnoU and alu.year=yearU and alu.Estado_idEstado!=7;  
...
SELECT pd.idDetallePago,pd.ImportePago,pd.NombrePago,pd.Estado_idEstado,pd.Cuota_idCuota,pd.TipoPago_idTipoPago,pd.NombrePago,pd.year,pd.Alumno_idAlumno from pagodetalle pd WHERE pd.Alumno_idAlumno=idAlumnoP and pd.year=yearP and pd.Estado_idEstado=9;
...
FROM alumno al INNER JOIN cuota cu ON cu.Alumno_idAlumno=al.idAlumno LEFT JOIN estado e ON e.idEstado=cu.Estado_idEstado WHERE cu.Alumno_idAlumno=idAlumnoU and cu.year=yearU and  cu.Estado_idEstado!=7;  
...
INSERT INTO `pagodetalle`(`idDetallePago`, `Cabecera_idCabecera`, `Alumno_idAlumno`, `year`, `NombrePago`, `ImportePago`, `Cuota_idCuota`, `TipoPago_idTipoPago`, `fechaRegistro`, `Estado_idEstado`) VALUES (NULL,NULL,idAlumnoP,yearP,TituloPago,pagarImp,NULL,codigoPago,NOW(),9);
...
UPDATE `alumnopagos` SET  `Diferencia`=@PagoDiferencia,`Estado_idEstado`=@ESTADO WHERE `Alumno_idAlumno`=idAlumnoP and `year`=yearP and `TipoPago_idTipoPago`=codigoPago;  


    if(pagarMora>0)then 
    SET @PagoMora=(impMora-pagarMora);
    
		INSERT INTO `pagodetalle`(`idDetallePago`, `Cabecera_idCabecera`, `Alumno_idAlumno`, `year`, `NombrePago`, `ImportePago`, `Cuota_idCuota`, `TipoPago_idTipoPago`, `fechaRegistro`, `Estado_idEstado`) VALUES (NULL,NULL,idAlumnoP,yearP,CONCAT("MORA DE ",TituloPago),pagarMora,NULL,codigoPago,NOW(),9);
  
UPDATE `alumnopagos` SET `Mora`=@PagoMora,`Estado_idEstado`=@ESTADO WHERE `Alumno_idAlumno`=idAlumnoP and `year`=yearP and `TipoPago_idTipoPago`=codigoPago;    
...
SET @PagoDiferencia=(impPago-pagarImp);
	...
	INSERT INTO `pagodetalle`(`idDetallePago`, `Cabecera_idCabecera`, `Alumno_idAlumno`, `year`, `NombrePago`, `ImportePago`, `Cuota_idCuota`, `TipoPago_idTipoPago`, `fechaRegistro`, `Estado_idEstado`) VALUES (NULL,NULL,idAlumnoP,yearP,TituloPago,pagarImp,codigoPago,NULL,NOW(),9);
...
UPDATE `cuota` SET  `Diferencia`=@PagoDiferencia,`Estado_idEstado`=@ESTADO WHERE `idCuota`=codigoPago and `Alumno_idAlumno`=idAlumnoP and `year`=yearP; 

    
if(pagarMora>0)then 
SET @PagoMora=(impMora-pagarMora);
		INSERT INTO `pagodetalle`(`idDetallePago`, `Cabecera_idCabecera`, `Alumno_idAlumno`, `year`, `NombrePago`, `ImportePago`, `Cuota_idCuota`, `TipoPago_idTipoPago`, `fechaRegistro`, `Estado_idEstado`) VALUES (NULL,NULL,idAlumnoP,yearP,CONCAT("MORA DE ",TituloPago),pagarMora,codigoPago,NULL,NOW(),9);
        
  UPDATE `cuota` SET `Mora`=@PagoMora,`Estado_idEstado`=@ESTADO WHERE `idCuota`=codigoPago and `Alumno_idAlumno`=idAlumnoP and `year`=yearP; 
...
(1, 4, 2017, 1, '250.00', '0.00', '0.00', 7, '2018-10-28 00:47:31'),
(2, 4, 2017, 3, '120.00', '0.00', '0.00', 7, '2018-10-28 00:47:31'),
(3, 4, 2017, 4, '100.00', '0.00', '0.00', 7, '2018-10-28 00:47:31'),
(4, 4, 2017, 5, '120.00', '0.00', '0.00', 7, '2018-10-28 00:47:31'),
(5, 4, 2017, 6, '100.00', '0.00', '0.00', 7, '2018-10-28 00:47:31'),
(6, 4, 2017, 7, '200.00', '0.00', '0.00', 7, '2018-10-28 00:47:31'),
(7, 5, 2017, 1, '250.00', '250.00', '0.00', 5, '2018-10-28 09:39:31'),
(8, 5, 2017, 3, '120.00', '120.00', '0.00', 5, '2018-10-28 09:39:31'),
(9, 5, 2017, 4, '100.00', '100.00', '0.00', 5, '2018-10-28 09:39:31'),
(10, 5, 2017, 5, '120.00', '120.00', '0.00', 5, '2018-10-28 09:39:31'),
(11, 5, 2017, 6, '100.00', '100.00', '0.00', 5, '2018-10-28 09:39:31'),
(12, 5, 2017, 7, '200.00', '200.00', '0.00', 5, '2018-10-28 09:39:31'),
(13, 6, 2017, 1, '250.00', '250.00', '0.00', 5, '2018-10-28 09:39:47'),
(14, 6, 2017, 3, '120.00', '120.00', '0.00', 5, '2018-10-28 09:39:47'),
(15, 6, 2017, 4, '100.00', '100.00', '0.00', 5, '2018-10-28 09:39:47'),
(16, 6, 2017, 5, '120.00', '120.00', '0.00', 5, '2018-10-28 09:39:47'),
(17, 6, 2017, 6, '100.00', '100.00', '0.00', 5, '2018-10-28 09:39:47'),
(18, 6, 2017, 7, '200.00', '200.00', '0.00', 5, '2018-10-28 09:39:47'),
...
(23, 8, 2017, 1, '250.00', '250.00', '0.00', 5, '2018-10-28 09:40:17'),
...
(48, 4, 2018, 1, '250.00', '250.00', '0.00', 5, '2018-10-28 17:32:18'),
(49, 4, 2018, 3, '120.00', '120.00', '0.00', 5, '2018-10-28 17:32:18'),
(50, 4, 2018, 4, '100.00', '100.00', '0.00', 5, '2018-10-28 17:32:18'),
(51, 4, 2018, 5, '120.00', '120.00', '0.00', 5, '2018-10-28 17:32:18'),
(52, 4, 2018, 6, '100.00', '100.00', '0.00', 5, '2018-10-28 17:32:18'),
(53, 5, 2018, 1, '250.00', '250.00', '0.00', 5, '2018-10-28 17:32:34'),
(54, 5, 2018, 3, '120.00', '120.00', '0.00', 5, '2018-10-28 17:32:34'),
(55, 5, 2018, 4, '100.00', '100.00', '0.00', 5, '2018-10-28 17:32:34'),
(56, 5, 2018, 5, '120.00', '120.00', '0.00', 5, '2018-10-28 17:32:34'),
(57, 5, 2018, 6, '100.00', '100.00', '0.00', 5, '2018-10-28 17:32:34'),
...
(873, 4, NULL, '200.00', '0.00', '0.00', 2017, 3, '2017-03-01', '2017-03-30', 7),
(874, 4, NULL, '200.00', '0.00', '0.00', 2017, 4, '2017-04-01', '2017-04-30', 7),
(875, 4, NULL, '200.00', '0.00', '0.00', 2017, 5, '2017-05-01', '2017-05-30', 7),
(876, 4, NULL, '200.00', '0.00', '0.00', 2017, 6, '2017-06-01', '2017-06-30', 7),
(877, 4, NULL, '200.00', '0.00', '0.00', 2017, 7, '2017-07-01', '2017-07-30', 7),
(878, 4, NULL, '200.00', '0.00', '0.00', 2017, 8, '2017-08-01', '2017-08-30', 7),
(879, 4, NULL, '200.00', '0.00', '0.00', 2017, 9, '2017-09-01', '2017-09-30', 7),
(880, 4, NULL, '200.00', '0.00', '0.00', 2017, 10, '2017-10-01', '2017-10-30', 7),
(881, 4, NULL, '200.00', '0.00', '0.00', 2017, 11, '2017-11-01', '2017-11-30', 7),
(882, 4, NULL, '200.00', '0.00', '0.00', 2017, 12, '2017-12-01', '2017-12-30', 7),
(883, 5, NULL, '200.00', '200.00', '0.00', 2017, 3, '2017-03-01', '2017-03-30', 5),
(884, 5, NULL, '200.00', '200.00', '0.00', 2017, 4, '2017-04-01', '2017-04-30', 5),
(885, 5, NULL, '200.00', '200.00', '0.00', 2017, 5, '2017-05-01', '2017-05-30', 5),
(886, 5, NULL, '200.00', '200.00', '0.00', 2017, 6, '2017-06-01', '2017-06-30', 5),
...
(893, 6, NULL, '200.00', '200.00', '0.00', 2017, 3, '2017-03-01', '2017-03-30', 5),
...
(973, 4, NULL, '200.00', '200.00', '0.00', 2018, 3, '2018-03-01', '2018-03-30', 5),
(974, 4, NULL, '200.00', '200.00', '0.00', 2018, 4, '2018-04-01', '2018-04-30', 5),
(975, 4, NULL, '200.00', '200.00', '0.00', 2018, 5, '2018-05-01', '2018-05-30', 5),
(976, 4, NULL, '200.00', '200.00', '0.00', 2018, 6, '2018-06-01', '2018-06-30', 5),
(977, 4, NULL, '200.00', '200.00', '0.00', 2018, 7, '2018-07-01', '2018-07-30', 5),
(978, 4, NULL, '200.00', '200.00', '0.00', 2018, 8, '2018-08-01', '2018-08-30', 5),
(979, 4, NULL, '200.00', '200.00', '0.00', 2018, 9, '2018-09-01', '2018-09-30', 5),
(980, 4, NULL, '200.00', '200.00', '0.00', 2018, 10, '2018-10-01', '2018-10-30', 5),
(981, 4, NULL, '200.00', '200.00', '0.00', 2018, 11, '2018-11-01', '2018-11-30', 5),
(982, 4, NULL, '200.00', '200.00', '0.00', 2018, 12, '2018-12-01', '2018-12-30', 5),
(983, 5, NULL, '200.00', '200.00', '0.00', 2018, 3, '2018-03-01', '2018-03-30', 5),
(984, 5, NULL, '200.00', '200.00', '0.00', 2018, 4, '2018-04-01', '2018-04-30', 5),
(985, 5, NULL, '200.00', '200.00', '0.00', 2018, 5, '2018-05-01', '2018-05-30', 5),
(986, 5, NULL, '200.00', '200.00', '0.00', 2018, 6, '2018-06-01', '2018-06-30', 5),
(987, 5, NULL, '200.00', '200.00', '0.00', 2018, 7, '2018-07-01', '2018-07-30', 5),
(988, 5, NULL, '200.00', '200.00', '0.00', 2018, 8, '2018-08-01', '2018-08-30', 5),
(989, 5, NULL, '200.00', '200.00', '0.00', 2018, 9, '2018-09-01', '2018-09-30', 5),
...
INSERT INTO `pagodetalle` (`idDetallePago`, `Cabecera_idCabecera`, `Alumno_idAlumno`, `year`, `NombrePago`, `ImportePago`, `Cuota_idCuota`, `TipoPago_idTipoPago`, `fechaRegistro`, `Estado_idEstado`) VALUES
(2, NULL, 4, 2017, 'Pago de Matricula', '250.00', NULL, 1, '2018-10-29 22:30:13', 9),
(3, NULL, 4, 2017, 'Pago de Computación', '120.00', NULL, 3, '2018-10-29 22:42:17', 9),
(4, NULL, 4, 2017, 'Pago de Certificado', '100.00', NULL, 4, '2018-10-29 22:42:24', 9),
(5, NULL, 4, 2017, 'Pago de Ingles', '120.00', NULL, 5, '2018-10-29 22:42:31', 9),
(6, NULL, 4, 2017, 'Pago Otro', '100.00', NULL, 6, '2018-10-29 22:42:39', 9),
(7, NULL, 4, 2017, 'Pago Otro', '100.00', NULL, 7, '2018-10-29 22:42:52', 9),
(8, NULL, 4, 2017, 'Pago Otro', '100.00', NULL, 7, '2018-10-29 22:43:12', 9),
(9, NULL, 4, 2017, 'PENSIÓN MARZO', '200.00', 873, NULL, '2018-10-29 22:43:43', 9),
(10, NULL, 4, 2017, 'MORA DE PENSIÓN MARZO', '578.00', 873, NULL, '2018-10-29 22:43:43', 9),
(11, NULL, 4, 2017, 'PENSIÓN ABRIL', '200.00', 874, NULL, '2018-10-29 23:11:25', 9),
(12, NULL, 4, 2017, 'MORA DE PENSIÓN ABRIL', '547.00', 874, NULL, '2018-10-29 23:11:25', 9),
(13, NULL, 4, 2017, 'PENSIÓN MAYO', '200.00', 875, NULL, '2018-10-29 23:11:34', 9),
(14, NULL, 4, 2017, 'MORA DE PENSIÓN MAYO', '517.00', 875, NULL, '2018-10-29 23:11:34', 9),
(15, NULL, 4, 2017, 'PENSIÓN JUNIO', '200.00', 876, NULL, '2018-10-29 23:11:40', 9),
(16, NULL, 4, 2017, 'MORA DE PENSIÓN JUNIO', '486.00', 876, NULL, '2018-10-29 23:11:40', 9),
(17, NULL, 4, 2017, 'PENSIÓN JULIO', '200.00', 877, NULL, '2018-10-29 23:12:02', 9),
(18, NULL, 4, 2017, 'MORA DE PENSIÓN JULIO', '456.00', 877, NULL, '2018-10-29 23:12:02', 9),
(19, NULL, 4, 2017, 'PENSIÓN AGOSTO', '200.00', 878, NULL, '2018-10-29 23:12:11', 9),
(20, NULL, 4, 2017, 'MORA DE PENSIÓN AGOSTO', '425.00', 878, NULL, '2018-10-29 23:12:11', 9),
(21, NULL, 4, 2017, 'PENSIÓN SEPTIEMBRE', '200.00', 879, NULL, '2018-10-29 23:12:17', 9),
(22, NULL, 4, 2017, 'MORA DE PENSIÓN SEPTIEMBRE', '394.00', 879, NULL, '2018-10-29 23:12:17', 9),
(23, NULL, 4, 2017, 'PENSIÓN OCTUBRE', '200.00', 880, NULL, '2018-10-29 23:12:23', 9),
(24, NULL, 4, 2017, 'MORA DE PENSIÓN OCTUBRE', '364.00', 880, NULL, '2018-10-29 23:12:23', 9),
(25, NULL, 4, 2017, 'PENSIÓN NOVIEMBRE', '200.00', 881, NULL, '2018-10-29 23:12:29', 9),
(26, NULL, 4, 2017, 'MORA DE PENSIÓN NOVIEMBRE', '333.00', 881, NULL, '2018-10-29 23:12:29', 9),
(27, NULL, 4, 2017, 'PENSIÓN DICIEMBRE', '200.00', 882, NULL, '2018-10-29 23:12:35', 9),
(28, NULL, 4, 2017, 'MORA DE PENSIÓN DICIEMBRE', '303.00', 882, NULL, '2018-10-29 23:12:35', 9);
